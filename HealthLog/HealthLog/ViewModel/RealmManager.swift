...
//    }
    ...
    func initializeRealmExercise() {
        if realm.objects(Exercise.self).isEmpty {
            let sampleExercises = [
                Exercise(name: "Squat", bodyParts: [.quadriceps, .glutes], descriptionText: "Leg exercise", image: nil, totalReps: 75, recentWeight: 80, maxWeight: 120, isCustom: false),
                ...
                Exercise(name: "Leg Press", bodyParts: [.quadriceps, .glutes], descriptionText: "Leg exercise", image: nil, totalReps: 50, recentWeight: 180, maxWeight: 200, isCustom: false),
